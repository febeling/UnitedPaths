// main sketch code: sketches/examples/clipping/full.pde
...
// source code include: sketches/common/Curves/CurvePair.pde
...
// source code include: sketches/common/utils/ConvexHull.pde
...
class ConvexHull
{
  ...
  Point[] jarvisMarch(ArrayList pointset, double minx, double miny)
  {
    ...
    // the result is a convex polygon that encloses all points in the set.
